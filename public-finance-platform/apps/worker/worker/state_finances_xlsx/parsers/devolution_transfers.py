"""RBI Statement 17 — Devolution and Transfer of Resources from the Centre (₹ Crore).
...
_SUBLABELS: dict[str, tuple[str, str]] = {
    "gross": ("devolution_from_centre_gross", "Devolution / Transfers from the Centre (Gross)"),
    "net": ("devolution_from_centre_net", "Devolution / Transfers from the Centre (Net)"),
    "net*": ("devolution_from_centre_net", "Devolution / Transfers from the Centre (Net)"),
}
