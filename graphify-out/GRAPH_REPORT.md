...
Cohesion: 0.12
Nodes (32): Base, BudgetHead, DatasetReleaseStatus, DebtEventType, ParserErrorLevel, ParserRun, ReconciliationResult, ReconciliationStatus (+24 more)
...
Cohesion: 0.09
Nodes (14): classify_document_family(), classify_document_family(), FakeHttpClient, FakeRepository, FakeStorage, test_checksum_deduplication_skips_duplicate_pdf_uploads(), test_classification_rules_cover_core_families(), FakeHttpClient (+6 more)
...
Cohesion: 0.16
Nodes (27): seed_reference_data(), DatasetRelease, DebtEvent, DebtInstrument, DebtPosition, DepartmentSpending, FiscalMetric, ProvenanceLink (+19 more)

### Community 16 - "CSV Export"
Cohesion: 0.14
Nodes (12): canonicalize_url(), log_event(), FetchRunRecord, SourceDocumentRecord, SourcePersistenceService, StoredDocument, _basename(), HttpClient (+4 more)

### Community 17 - "Alembic Config"
Cohesion: 0.15
Nodes (10): ParsedBorrowingRecord, RbiSourceSpec, _looks_like_pdf(), RbiBorrowingIngestionService, FailingPdfFetcher, StubFetcher, StubPersistence, test_service_creates_manual_review_when_anti_bot_detected() (+2 more)
...
Cohesion: 0.17
Nodes (10): RbiIngestionMetrics, ParsedBorrowingRecord, RbiPersistence, RbiBorrowingIngestionService, _record(), test_idempotent_upsert_for_instruments_and_events(), test_manual_review_task_is_persisted(), _record() (+2 more)

### Community 23 - "Loading State"
Cohesion: 0.14
Nodes (8): configure_logging(), FixedWindowRateLimiter, get_correlation_id(), install_observability(), is_public_api_path(), JsonLogFormatter, MetricsRegistry, get_correlation_id()

### Community 24 - "Admin Layout"
Cohesion: 0.13
Nodes (11): default(), SourceRegistry, SourceRegistryEntry, _source_specs(), default(), SourceRegistry, SourceRegistryEntry, fetch_official_sources() (+3 more)

### Community 25 - "Admin Document Page"
Cohesion: 0.16
Nodes (11): _AnchorParser, DiscoveredLink, extract_page_title(), extract_pdf_links(), _looks_like_pdf(), _AnchorParser, DiscoveredLink, extract_page_title() (+3 more)

### Community 26 - "Admin Releases Page"
Cohesion: 0.13
Nodes (5): _infer_extension(), RawArtifactStorage, _infer_extension(), RawArtifactStorage, S3StorageAdapter

### Community 27 - "Review Queue Page"
Cohesion: 0.2
Nodes (8): canonicalize_url(), fetch_official_sources(), log_event(), FetchRunRecord, SourceDocumentRecord, SourcePersistenceService, StoredDocument, SourceDiscoveryCrawler

### Community 29 - "Provenance Drawer"
Cohesion: 0.13
Nodes (8): CrawlMetrics, get_crawler_logger(), ExtractorProvider, Protocol that every extractor implementation must satisfy., CrawlMetrics, get_crawler_logger(), Protocol, HttpClient

### Community 30 - "Source Drawer"
Cohesion: 0.28
Nodes (13): create_schema(), create_schema(), seed_reference_data(), Base, SourceDocument, Basis, ChangelogEntry, IngestionRun (+5 more)

### Community 31 - "Release Workspace"
Cohesion: 0.22
Nodes (11): lifespan(), root(), get_db(), get_engine(), get_session_factory(), SessionLocal(), lifespan(), get_db() (+3 more)
...
Cohesion: 0.27
Nodes (12): AdminWorkflowStateResponse, audit_trail(), annotate_reconciliation(), audit_trail(), compare_conflicts(), decide_fact(), list_documents(), list_review_queue() (+4 more)
...
Cohesion: 0.28
Nodes (6): FetchOutcome, RbiSourceSpec, StubFetcher, StubPersistence, test_service_creates_manual_review_when_anti_bot_detected(), test_service_stores_wma_context_when_no_structured_rows()
...
- **Why does `str()` connect `Singleton 47` to `Ingestion & Discovery Tests`, `RBI Parser Tests`, `CAG/AP Finance Parsers`, `Reparse & Health Ops`, `Public API Layer`, `AP Finance Fetcher`, `AP Finance Tests`, `CSV Export`, `Alembic Config`, `Admin Layout`, `Health Route`, `Review Dashboard`, `Basis Badge`, `Last Updated`, `Trust Copy`, `Worker Config Test`, `Singleton 43`, `Singleton 45`, `Singleton 46`, `Singleton 49`, `Singleton 54`?**
  _High betweenness centrality (0.192) - this node is a cross-community bridge._
- **Why does `str()` connect `Admin Review Service` to `Ingestion & Discovery Tests`, `Review Dashboard`, `RBI Parser Tests`, `CAG/AP Finance Parsers`, `Reparse & Health Ops`, `Public API Layer`, `Singleton 40`, `AP Finance Fetcher`, `AP Finance Tests`, `Singleton 43`, `Singleton 46`, `Singleton 49`, `Singleton 54`, `Root Layout`, `Review Queue Page`?**
  _High betweenness centrality (0.164) - this node is a cross-community bridge._
- **Why does `parseCommonFilters()` connect `AP Finance Tests` to `Singleton 47`?**
